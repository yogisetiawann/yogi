...
class Voucher_bumdes extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('Bumdes/v_tabelvoucher_b', $data);
    ...
    public function inserWTODataVoucher()
    {
        ...
        return redirect()->to(base_url('Voucher_bumdes'));
    }
    ...
    public function edit($id)
    {
        ...
        echo view('Bumdes/admin_header_bumdes', $data);
        echo view('Bumdes/v_editvoucher_b', $data);
        echo view('Bumdes/admin_footer_bumdes', $data);
    }
