            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text">Selamat Datang <span class="text-black fw-bold"><?php echo session()->get('username'); ?></span></h1>
                        <h3 class="welcome-sub-text"><span class="text-black fw-bold">Poin Milikmu :</span> <?php echo $data['poin'] ?></h3>
                    </li>
                </ul>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?= base_url('LihatSampah') ?>">Lihat Sampah</a></li>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="home-tab">
                                <img src="images/banksampah.png" alt="logo">
                            </div>
                        </div>
                    </div>
                </div>
