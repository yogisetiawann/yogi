...
<body>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="<?= base_url('Produk/cariVoucher'); ?>" method="GET">
    ...
    <script>
        function showConfirmationAlert(voucherId) {
            Swal.fire({
                title: 'Konfirmasi',
                text: 'Apakah Anda yakin ingin validasi voucher ini?',
                icon: 'question',
                ...
                if (result.isConfirmed) {
                    window.location.href = '<?= base_url('LihatProduk/validasiVoucher/'); ?>' + voucherId;
                }
            });
        }
    </script>
