            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        <a href="<?= base_url() ?>/templates/index.html" class="nav-item nav-link active">Home</a>
                        <a href="<?= base_url() ?>/templates/about.html" class="nav-item nav-link">About</a>
                        <a href="<?= base_url() ?>/templates/service.html" class="nav-item nav-link">Service</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                            <div class="dropdown-menu m-0">
                                <a href="<?= base_url() ?>/templates/feature.html" class="dropdown-item">Features</a>
                                <a href="<?= base_url() ?>/templates/quote.html" class="dropdown-item">Login</a>
                                <a href="<?= base_url() ?>/templates/team.html" class="dropdown-item">Our Team</a>
                                <a href="<?= base_url() ?>/templates/testimonial.html" class="dropdown-item">Testimonial</a>
                                <a href="<?= base_url() ?>/templates/404.html" class="dropdown-item">404 Page</a>
                            </div>
                        </div>
                        <a href="<?= base_url() ?>/templates/contact.html" class="nav-item nav-link">Contact</a>
                    </div>
                ...
                <div class="container">
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated zoomIn">Desa Situsari menyediakan Webiste Bank Sampah</h1>
        ...
        <div class="container-xxl bg-primary my-6 py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container">
                <div class="owl-carousel client-carousel">
                    ...
                    <a href="#"><img class="img-fluid" src="<?= base_url() ?>/templates/img/logo-3.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="<?= base_url() ?>/templates/img/logo-4.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="<?= base_url() ?>/templates/img/logo-5.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="<?= base_url() ?>/templates/img/logo-6.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="<?= base_url() ?>/templates/img/logo-7.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="<?= base_url() ?>/templates/img/logo-8.png" alt=""></a>
                </div>
            </div>
        </div>
        <!-- Client End -->
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item">
                            <h5>Ridho Januar Rifadha</h5>
                            <p class="mb-4">CEO Ecory Co</p>
                            <img class="img-fluid rounded-circle w-100 mb-4" src="<?= base_url() ?>/templates/img/team-1.jpg" alt="">
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item">
                            ...
                            <img class="img-fluid rounded-circle w-100 mb-4" src="<?= base_url() ?>/templates/img/team-2.jpg" alt="">
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-linkedin-in"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item">
                            <h5>Full Name</h5>
                            <p class="mb-4">Designation</p>
                            <img class="img-fluid rounded-circle w-100 mb-4" src="<?= base_url() ?>/templates/img/team-3.jpg" alt="">
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-linkedin-in"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="team-item">
                            <h5>Full Name</h5>
                            <p class="mb-4">Designation</p>
                            <img class="img-fluid rounded-circle w-100 mb-4" src="<?= base_url() ?>/templates/img/team-4.jpg" alt="">
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-linkedin-in"></i></a>
