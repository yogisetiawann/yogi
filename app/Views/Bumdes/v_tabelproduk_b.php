                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<?= base_url('/admin_bumdes')?>">Home</a></li>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;" class="action-buttons">
                                                    <?php if ($row['status_produk'] == 'aktif') : ?>
                                                        <a href="<?= base_url('Produk_bumdes/deactivate/' . $row['id']); ?>" class="btn btn-danger btn-sm btn-activate">Nonaktifkan</a>
                                                    <?php else : ?>
                                                        <a href="<?= base_url('Produk_bumdes/activate/' . $row['id']); ?>" class="btn btn-success btn-sm btn-activate">Aktifkan</a>
                                                    <?php endif; ?>

                                                    <a href="<?= base_url('Produk_bumdes/edit/' . $row['id']); ?>" class="btn btn-success btn-sm btn-edit">Edit</a>
<!-- 
                                                    <a href="<?= base_url('Produk_bumdes/delete/' . $row['id']); ?>" class="btn btn-danger btn-sm btn-delete">Delete</a> -->
                                ...
                                <div class="row mt-3">
                                    <div class="col-12">
                                        <a href="<?= base_url('AddProduk_bumdes') ?>" class="btn btn-success float-right btn-add">Tambah Voucher</a>
                                    </div>
                                </div>
                            </div>
                        </div>
